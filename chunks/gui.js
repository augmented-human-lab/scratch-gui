...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var react_ga__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-ga */ "./node_modules/react-ga/dist/react-ga.js");
...
var GA_ID = ((_window = window) === null || _window === void 0 ? void 0 : (_window$configs = _window.configs) === null || _window$configs === void 0 ? void 0 : _window$configs['GA_ID']) || process.env.GA_ID;
if (GA_ID) {
  react_ga__WEBPACK_IMPORTED_MODULE_0___default.a.initialize(GA_ID, {
    debug: "undefined" !== 'production',
    titleCase: true,
    sampleRate:  false ? undefined : 0,
    forceSSL: true
  });
} else {
  _log__WEBPACK_IMPORTED_MODULE_1__["default"].info('Disabling GA because GA_ID is not set.');
  window.ga = function () {
...
/* harmony default export */ __webpack_exports__["default"] = (react_ga__WEBPACK_IMPORTED_MODULE_0___default.a);
...
/* harmony import */ var _lib_analytics_kiwrious__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../lib/analytics-kiwrious */ "./src/lib/analytics-kiwrious.js");
...
_lib_log__WEBPACK_IMPORTED_MODULE_11__["default"].info("version ".concat(((_window = window) === null || _window === void 0 ? void 0 : (_window$configs = _window.configs) === null || _window$configs === void 0 ? void 0 : _window$configs['APP_VERSION']) || "3.2.37"));
_lib_log__WEBPACK_IMPORTED_MODULE_11__["default"].info("cloud_run_service ".concat(((_window2 = window) === null || _window2 === void 0 ? void 0 : (_window2$configs = _window2.configs) === null || _window2$configs === void 0 ? void 0 : _window2$configs['CLOUD_RUN_SERVICE']) || "https://padlet-service-722108111513.us-central1.run.app:8080/api"));
_lib_log__WEBPACK_IMPORTED_MODULE_11__["default"].info("padlet_target ".concat(((_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$configs = _window3.configs) === null || _window3$configs === void 0 ? void 0 : _window3$configs['PADLET_TARGET']) || "https://padlet.com/KiwriousPlay/kiwrious-play-49fsmsyic2yhrfr1"));
...
_lib_analytics_kiwrious__WEBPACK_IMPORTED_MODULE_6__["default"].pageview('/');
